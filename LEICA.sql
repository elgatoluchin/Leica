...
CREATE TABLE IF NOT EXISTS `LEICA`.`USUARIO` (
  ...
  CONSTRAINT `fk_USUARIO_GRUPO_USUARIO1`
    FOREIGN KEY (`GRUPO_USUARIO_ID_TIPO_USUARIO`)
    REFERENCES `LEICA`.`GRUPO_USUARIO` (`ID_GRUPO_USUARIO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `LEICA`.`SOLICITUD` (
  ...
  CONSTRAINT `fk_SOLICITUD_ESTADO1`
    ...
    REFERENCES `LEICA`.`ESTADO_SOLICITUD` (`ID_EST`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_SOLICITUD_USUARIO1`
    FOREIGN KEY (`USUARIO_RUT_USU` , `USUARIO_AREA_ID_AREA` , `USUARIO_GRUPO_USUARIO_ID_TIPO_USUARIO`)
    REFERENCES `LEICA`.`USUARIO` (`RUT_USU` , `AREA_ID_AREA` , `GRUPO_USUARIO_ID_TIPO_USUARIO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `LEICA`.`HIST_SESSION` (
  ...
  `USUARIO_RUT_USU` VARCHAR(11) CHARACTER SET 'utf8' NOT NULL,
  `USUARIO_AREA_ID_AREA` INT NOT NULL,
  `USUARIO_TIPO_USUARIO_ID_TIPO_USUARIO` INT NOT NULL,
  PRIMARY KEY (`ID_HIST_SESSION`, `USUARIO_RUT_USU`, `USUARIO_AREA_ID_AREA`, `USUARIO_TIPO_USUARIO_ID_TIPO_USUARIO`),
  INDEX `fk_HIST_SESSION_USUARIO1_idx` (`USUARIO_RUT_USU` ASC, `USUARIO_AREA_ID_AREA` ASC, `USUARIO_TIPO_USUARIO_ID_TIPO_USUARIO` ASC),
  CONSTRAINT `fk_HIST_SESSION_USUARIO1`
    FOREIGN KEY (`USUARIO_RUT_USU` , `USUARIO_AREA_ID_AREA`)
    REFERENCES `LEICA`.`USUARIO` (`RUT_USU` , `AREA_ID_AREA`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
