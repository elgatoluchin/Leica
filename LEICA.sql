...
CREATE TABLE IF NOT EXISTS `LEICA`.`USUARIO` (
  ...
  CONSTRAINT `fk_USUARIO_AREA1`
    ...
    REFERENCES `LEICA`.`AREA` (`ID_AREA`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_USUARIO_TIPO_USUARIO1`
    FOREIGN KEY (`TIPO_USUARIO_ID_TIPO_USUARIO`)
    REFERENCES `LEICA`.`TIPO_USUARIO` (`ID_TIPO_USUARIO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `LEICA`.`ASIGNATURA` (
  ...
  CONSTRAINT `fk_ASIGNATURA_AREA1`
    FOREIGN KEY (`AREA_ID_AREA`)
    REFERENCES `LEICA`.`AREA` (`ID_AREA`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `LEICA`.`MATERIALES` (
  ...
  CONSTRAINT `fk_MATERIALES_TIPO_MATERIAL1`
    ...
    REFERENCES `LEICA`.`TIPO_MATERIAL` (`ID_TIPO_MATERIAL`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `LEICA`.`SOLICITUD` (
  ...
  CONSTRAINT `fk_SOLICITUD_LABORATORIO1`
    FOREIGN KEY (`LABORATORIO_ID_LAB`)
    REFERENCES `LEICA`.`LABORATORIO` (`ID_LAB`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_SOLICITUD_ASIGNATURA1`
    FOREIGN KEY (`ASIGNATURA_ID_ASIG` , `ASIGNATURA_AREA_ID_AREA`)
    REFERENCES `LEICA`.`ASIGNATURA` (`ID_ASIG` , `AREA_ID_AREA`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_SOLICITUD_USUARIO1`
    FOREIGN KEY (`USUARIO_ID_USU` , `USUARIO_AREA_ID_AREA`)
    REFERENCES `LEICA`.`USUARIO` (`ID_USU` , `AREA_ID_AREA`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_SOLICITUD_ESTADO1`
    FOREIGN KEY (`ESTADO_ID_EST`)
    REFERENCES `LEICA`.`ESTADO` (`ID_EST`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_SOLICITUD_MATERIALES1`
    FOREIGN KEY (`MATERIALES_ID_MAT` , `MATERIALES_TIPO_MATERIAL_ID_TIPO_MATERIAL`)
    REFERENCES `LEICA`.`MATERIALES` (`ID_MAT` , `TIPO_MATERIAL_ID_TIPO_MATERIAL`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `LEICA`.`HIST_SESSION` (
  ...
  CONSTRAINT `fk_HIST_SESSION_USUARIO1`
    FOREIGN KEY (`USUARIO_ID_USU` , `USUARIO_AREA_ID_AREA` , `USUARIO_TIPO_USUARIO_ID_TIPO_USUARIO`)
    REFERENCES `LEICA`.`USUARIO` (`ID_USU` , `AREA_ID_AREA` , `TIPO_USUARIO_ID_TIPO_USUARIO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Data for table `LEICA`.`TIPO_USUARIO`
-- -----------------------------------------------------
START TRANSACTION;
USE `LEICA`;
INSERT INTO `LEICA`.`TIPO_USUARIO` (`ID_TIPO_USUARIO`, `DESC_TIPO_USU`) VALUES (1, 'Administrador');
INSERT INTO `LEICA`.`TIPO_USUARIO` (`ID_TIPO_USUARIO`, `DESC_TIPO_USU`) VALUES (2, 'Alumno');
INSERT INTO `LEICA`.`TIPO_USUARIO` (`ID_TIPO_USUARIO`, `DESC_TIPO_USU`) VALUES (3, 'Docente');
...
START TRANSACTION;
USE `LEICA`;
INSERT INTO `LEICA`.`USUARIO` (`ID_USU`, `PASS_USU`, `NOM_USU`, `APE_USU`, `EDAD_USU`, `SEXO_USU`, `FECHA_NAC_USU`, `TELEFONO_USU`, `CORREO_USU`, `ESTADO_USU`, `CARRERA_USU`, `AREA_ID_AREA`, `TIPO_USUARIO_ID_TIPO_USUARIO`) VALUES (1, 'rockman0', 'luigi', 'zuñiga', 25, 'MASCULINO', '1990-07-04', '56977567020', 'luis.alberto.zuniga@outlook.com', 'activo', 'Ingenieria en magia', 1, 1);
INSERT INTO `LEICA`.`USUARIO` (`ID_USU`, `PASS_USU`, `NOM_USU`, `APE_USU`, `EDAD_USU`, `SEXO_USU`, `FECHA_NAC_USU`, `TELEFONO_USU`, `CORREO_USU`, `ESTADO_USU`, `CARRERA_USU`, `AREA_ID_AREA`, `TIPO_USUARIO_ID_TIPO_USUARIO`) VALUES (2, 'jmbp-2016', 'jbeltran', 'beltran', 26, 'MASCULINO', '1990-04-27', '56961246566', 'jorge.beltran06@hotmail.com', 'activo', 'Catador de nabos', 1, 1);
...
-- -----------------------------------------------------
-- Data for table `LEICA`.`ESTADO`
-- -----------------------------------------------------
START TRANSACTION;
USE `LEICA`;
INSERT INTO `LEICA`.`ESTADO` (`ID_EST`, `ESTADO_APROB`) VALUES (1, 'PENDIENTE');
INSERT INTO `LEICA`.`ESTADO` (`ID_EST`, `ESTADO_APROB`) VALUES (2, 'APROBADA');
INSERT INTO `LEICA`.`ESTADO` (`ID_EST`, `ESTADO_APROB`) VALUES (3, 'RECHAZADA');
...
START TRANSACTION;
USE `LEICA`;
INSERT INTO `LEICA`.`SOLICITUD` (`ID_SLT`, `FECHA_SLT`, `HORA_INI_SLT`, `HORA_FIN_SLT`, `DESC_SLT`, `LABORATORIO_ID_LAB`, `ASIGNATURA_ID_ASIG`, `ASIGNATURA_AREA_ID_AREA`, `USUARIO_ID_USU`, `USUARIO_AREA_ID_AREA`, `ESTADO_ID_EST`, `MATERIALES_ID_MAT`, `MATERIALES_TIPO_MATERIAL_ID_TIPO_MATERIAL`) VALUES (1, '2016-07-12', '11:10', '12:40', 'Se realizara la clase de IT Essentials', 'LAB7', 'IT0001', 1, 1, 1, 1, 'PV7V5D4011038', 1);
INSERT INTO `LEICA`.`SOLICITUD` (`ID_SLT`, `FECHA_SLT`, `HORA_INI_SLT`, `HORA_FIN_SLT`, `DESC_SLT`, `LABORATORIO_ID_LAB`, `ASIGNATURA_ID_ASIG`, `ASIGNATURA_AREA_ID_AREA`, `USUARIO_ID_USU`, `USUARIO_AREA_ID_AREA`, `ESTADO_ID_EST`, `MATERIALES_ID_MAT`, `MATERIALES_TIPO_MATERIAL_ID_TIPO_MATERIAL`) VALUES (2, '2016-03-25', '13:25', '14:55', 'Se realiza la clase de Networking', 'LK01', 'IT0002', 2, 2, 1, 1, 'lOCOm5', 1);
